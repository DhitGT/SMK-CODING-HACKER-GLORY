<?php 
    ...
    $posts = getFavPosts($selectedFilter,$searchTerm,$page);
...
<body>
    ...
    <div class="container mx-auto">
        <section id='post'>
            ...
            <div class="post-wrapper flex flex-col gap-4 items-center bg-gray-200 mt-7 rounded-xl p-2 justify-center py-20">
                <?php foreach ($posts as $data): ?>
                <div id="<?php echo $data['id'] ?>" class="post-card bg-white md:w-3/4 w-[90%] rounded p-4 shadow-2xl">
